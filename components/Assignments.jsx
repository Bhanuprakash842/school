...
const Assignments = ({ initialAssignments, currentStudentId }) => {
  ...
  }, [selectedFile, uploadingAssignmentId, studentId]);
              ...
              {status === 'pending' && getDueDateStatus(assignment.dueDate) ? (
                <div className="flex items-center">
                  ...
                  <label
                    ...
                    className="cursor-pointer bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-300 flex items-center"
                  >
